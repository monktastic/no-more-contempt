...
### How are we supposed to fight evil, if not for contempt?

This work is primarily intended to answer the question "_why_ should we avoid contempt?" We can't give a complete answer as to *how* (other than "become enlightened"). Still, some things can be said.

As we've noted, people are _exquisitely_ sensitive to our motivations. It is entirely possible to fight fiercely (and even violently[^dalai-lama-gun]) without resorting to contempt. In that case, people can sense that our action is fundamentally benevolent, and so it doesn't reinforce the evil in their minds (though any latent evil may still play out for a while, which may make us fear it's not working).

This is only possible to the degree you recognize the evil as not being intrinsic to their minds (or, equivalently, to the degree you see yourself in them). Ultimately, everything comes down to that, and that in turn requires first discovering how your _own_ self-deception operates (see below).

Such behavior could be considered next-level "tough love." It can also be called compassion (more on that below).
...
This mechanism is ultimately responsible for _all_ misbehavior. Even the most evil person could not do what they do without it, and conversely, you yourself are capable of almost anything under the right circumstances[^right-circumstances].

The more self-deception we harbor, the more eagerly we seek it out in others. We then try to force them to own up to theirs, but this backfires miserably: they can sense that we are in no position to be doing such a thing, and so they simply return the favor.

We act dismayed, but part of us secretly _wants_ this outcome...
...
Consider how much more satisfying it is to watch a bad person "get owned" than to see them have a change of heart—despite the latter actually being helpful. Part of us is more than happy to throw people under the bus in order to uphold our self-image as "good people" (if we have that self-image)—but this requires plausible deniability. This is why we must see them as _irredeemably_ bad: it leaves zero doubt that our malice is _good_.

It can be _extremely hard_ to admit (or even detect) that we're doing this, for obvious reasons. But it is not until we see exactly _why_ it's so hard that we begin to understand what prevents the "bad people" from consciously recognizing _their_ self-deception—and we can't fix what we don't understand. Until then, we are liable to unknowingly amplify it.

To summarize: all evil is enabled by self-deception, which itself is rooted in misperception. Contempt is a cleverly disguised attempt to induce this misperception in others—target, allies, and bystanders alike. It thereby enables more evil, regardless of who it is directed at—and part of us _needs_ this, to justify our misperception.
...
However, for various reasons, we lose contact with our "absolute goodness," which forces us to seek it _relatively_; that is, at the expense of others. We _need_ to see others as "bad" so that we can know ourselves as "good." This gives us an incentive to _make_ them bad. But even as we do so, part of us knows that we're doing this, so we have to hide it even harder, thus intensifying the process in a horrifying feedback loop. The worse we become, the harder it is to realize it.

In this state I _need_ evil to exist, so that I have something to fight, to prove my goodness.

Ironically, it is our memory of our original goodness that is the root cause of our misbehavior. Only by coming back into direct contact with it can we can stop contributing to this horrific cycle. That requires inner work. Evil keeps our attention fixated outward, on the evil "out there," precisely to prevent us from doing the one thing that could actually end it.
...
We could say that it's acting in accordance with one's inner light. We could also say that it's being free of misperception / self-deception / malice, which amounts to the same thing. But it can be _exceptionally_ hard to detect self-deception in ourselves. In fact, the more righteous we feel, the more surely we are engaged in self-deception. Self-righteousness exists _only_ as a cover.

There are a few ways we usually get the definition wrong:
...
2. It is not about obeying some "moral principles." Reality is in constant flux, whereas principles never change. It is certainly not about _enforcing_ your principles on others, however "kind" they may be.

3. Hating bad people is not kind; it is evil. [Also see pseudo-kindness.]

Ultimately, it is about being radically honest with oneself. You could say that kindness is never "for" a particular person, but only ever for reality as a whole. It feels like a fierce, uncompromising love for the world. By this definition, it is _always_ the right motivation in every circumstance—though even this should not be thought of as a "principle," but as a pointer.

How does this "end evil"? By cutting through self-deception; i.e., reminding people of _their_ inner light. Yes, even shooting someone can do that under the right circumstances—though be very careful here: violence is almost always self-deception. Most situations require much more gentle reminders. Part of you always knows what you're really up to, and you _will_ have to confront it sooner or later.
...
This is when we are cruel to one person in the name of helping another. This is cleverly-disguised evil, and is painfully common because it is somehow still socially acceptable.
