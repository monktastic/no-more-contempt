...
People are _ridiculously_ sensitive to our motivations (if only subconsciously), and malice makes us appear subtly (or not-so-subtly) evil to them. This triggers exactly the same reaction in "bad people" that their apparent evil does in us: it evokes malice, which makes them look even more evil to us, leading to a downward spiral into Hell. It doesn't require physical violence; it can be kicked off by a dehumanizing gaze.
