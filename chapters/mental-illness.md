...
The same is true for alcoholism, addiction, obesity, and countless other conditions. It seems we have to re-learn the same lesson each time, using new science as justification — even though it is always possible to see that the deepest aspect of people's minds simply couldn't want to suffer. This "empathy shortcut" allows one to see that contempt makes zero sense in such situations. "Tough love" may still be required, but it is still a form of love — and the deepest aspect of *our* mind knows the difference. Our descendants will surely wonder how we ever overlooked this.

What may be harder to see is that this "base layer of mind" also doesn't want _others_ to suffer. People certainly act like they do, and even sometimes say that they do — in which case it is dangerously naive not to believe them — but something surprisingly similar is going on beneath the surface. Their confused state is generated by a haze of profound delusion that would horrify them if they ever manage to break free of it. I do not have the neuroscience to prove this to you (yet), but it is plain for anyone with the eyes to see.

Contempt for such people is bad for exactly the same reason as for their victims: it merely compounds the delusion that's causing the problem to begin with. Theirs is simply a more cleverly disguised form of mental illness. The very deepest part of us knows this, but that knowledge somehow isn't reaching our conscious awareness. As we will soon see, this is a motivated ignorance.
